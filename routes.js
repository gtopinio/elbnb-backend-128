...
module.exports = (app, pool) => {
    ...
    app.post("/user/update-user-pic", userController.uploadUserPic(pool));
    ...
    app.post("/accommodation/update-accommodation-pic", accomodationController.updateAccommodationPicture(pool));
