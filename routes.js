...
module.exports = (app, pool) => {
    ...
    app.post("/accommodations/is-favorite", authController.isAccommodationFavorited(pool));
    app.post("/get-accommodation-ratings", authController.getAccommodationRatings(pool));
}